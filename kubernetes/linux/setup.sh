...
wget https://dl.influxdata.com/telegraf/releases/telegraf-1.19.2_linux_amd64.tar.gz
tar -zxvf telegraf-1.19.2_linux_amd64.tar.gz

mv /opt/telegraf-1.19.2/usr/bin/telegraf /opt/telegraf
...
rm -f $TMPDIR/envmdsd
rm -f $TMPDIR/telegraf-*_linux_amd64.tar.gz
