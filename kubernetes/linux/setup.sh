...
#install oneagent - Latest dev bits (7/17). We will create a dependency release and upload to it when we have final ship bits for this release.
wget https://dockerprovider.blob.core.windows.net/mdsdagent/azure-mdsd_1.5.124-build.develop.1294_x86_64.deb
