...
# build with workspacekeyFile - 05112021
wget https://github.com/microsoft/Docker-Provider/raw/gangams/ci-aad-auth-msi/oneagent-dev/azure-mdsd_1.11.0-build.develop.1992_x86_64.deb
