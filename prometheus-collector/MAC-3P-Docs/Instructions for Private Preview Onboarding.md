...
Go to [Azure Managed Service for Prometheus Rules Private Preview onboarding](./ConfigureRules.md) for additional information and guidance on creating alert rules and recording rules.
