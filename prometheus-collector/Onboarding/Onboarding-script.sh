...
az deployment group create --resource-group $resourceGroup --template-file RootTemplate.json --parameters monitoringAccountName=$monitoringAccountName monitoringAccountLocation=$trimmedLocation targetAKSResource=$aksResourceId
