...
class FilterHealthModelBuilderTest < Test::Unit::TestCase
  ...
  #         records =  Oj.load(file)

  #         node_inventory =  Oj.load(File.read(nodes_file_map[scenario]))
  #         pod_inventory =  Oj.load(File.read(pods_file_map[scenario]))
  #         deployment_inventory =  Oj.load(File.read(File.join(__dir__, "../../../../inventory/deployments.json")))
  ...
  #         node_inventory =  Oj.load(File.read(nodes_file_map["aks-engine-#{scenario}"]))
  #         pod_inventory =  Oj.load(File.read(pods_file_map["aks-engine-#{scenario}"]))
  #         deployment_inventory =  Oj.load(File.read(File.join(__dir__, "../../../../inventory/aks-engine/deployments.json")))
  #         resources = HealthKubernetesResources.instance
  #         resources.node_inventory = node_inventory
  #         resources.pod_inventory = pod_inventory
  ...
  #     node_inventory =  Oj.load(File.read("C:/Users/dilipr/desktop/health/container_cpu_memory/nodes.json"))
  #     pod_inventory =  Oj.load(File.read("C:/Users/dilipr/desktop/health/container_cpu_memory/pods.json"))
  #     deployment_inventory =  Oj.load(File.read("C:/Users/dilipr/desktop/health/container_cpu_memory/deployments.json"))
  #     resources = HealthKubernetesResources.instance
  #     resources.node_inventory = node_inventory
  #     resources.pod_inventory = pod_inventory
  #     resources.set_replicaset_inventory(deployment_inventory)
  ...
  def test_get_workload_name
    # node_inventory =  Oj.load(File.read("C:/AzureMonitor/ContainerInsights/Docker-Provider/test/code/plugin/health/dilipr-health-test-nodes.json"))
    # pod_inventory =  Oj.load(File.read('C:/AzureMonitor/ContainerInsights/Docker-Provider/test/code/plugin/health/dilipr-health-test-pods.json'))
    # replicaset_inventory =  Oj.load(File.read('C:/AzureMonitor/ContainerInsights/Docker-Provider/test/code/plugin/health/dilipr-health-test-rs.json'))
    node_inventory = Oj.load(File.read("C:/AzureMonitor/ContainerInsights/Docker-Provider/test/code/plugin/health/jobyaks2-nodes.json"))
    pod_inventory = Oj.load(File.read("C:/AzureMonitor/ContainerInsights/Docker-Provider/test/code/plugin/health/jobyaks2-pods.json"))
    replicaset_inventory = Oj.load(File.read("C:/AzureMonitor/ContainerInsights/Docker-Provider/test/code/plugin/health/jobyaks2-rs.json"))
    resources = HealthKubernetesResources.instance
    resources.node_inventory = node_inventory
    resources.pod_inventory = pod_inventory
