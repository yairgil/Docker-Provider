...
class CIM_Collection_Class : public CIM_ManagedElement_Class
{
public:
    
    typedef CIM_Collection Self;
    
    CIM_Collection_Class() :
        CIM_ManagedElement_Class(&CIM_Collection_rtti)
    {
    }
    ...
    CIM_Collection_Class& operator=(
        const CIM_Collection_Class& x)
    {
        CopyRef(x);
        return *this;
    }
    ...
    {
        return &CIM_Collection_rtti;
    }

};

typedef Array<CIM_Collection_Class> CIM_Collection_ClassA;
