...
class CIM_ConcreteJob_RequestStateChange_Class : public Instance
{
public:
    
    typedef CIM_ConcreteJob_RequestStateChange Self;
    
    CIM_ConcreteJob_RequestStateChange_Class() :
        Instance(&CIM_ConcreteJob_RequestStateChange_rtti)
    {
    }
    
    CIM_ConcreteJob_RequestStateChange_Class(
        const CIM_ConcreteJob_RequestStateChange* instanceName,
        bool keysOnly) :
        Instance(
    ...
    CIM_ConcreteJob_RequestStateChange_Class& operator=(
        const CIM_ConcreteJob_RequestStateChange_Class& x)
    {
        CopyRef(x);
        return *this;
    }
    ...
    //
    // CIM_ConcreteJob_RequestStateChange_Class.MIReturn
    //
    ...
    //
    // CIM_ConcreteJob_RequestStateChange_Class.RequestedState
    //
    ...
    //
    // CIM_ConcreteJob_RequestStateChange_Class.TimeoutPeriod
    //
...
typedef Array<CIM_ConcreteJob_RequestStateChange_Class> CIM_ConcreteJob_RequestStateChange_ClassA;

class CIM_ConcreteJob_GetError_Class : public Instance
{
public:
    
    typedef CIM_ConcreteJob_GetError Self;
    
    CIM_ConcreteJob_GetError_Class() :
        Instance(&CIM_ConcreteJob_GetError_rtti)
    {
    }
    
    CIM_ConcreteJob_GetError_Class(
        const CIM_ConcreteJob_GetError* instanceName,
        bool keysOnly) :
        Instance(
    ...
    CIM_ConcreteJob_GetError_Class& operator=(
        const CIM_ConcreteJob_GetError_Class& x)
    {
        CopyRef(x);
        return *this;
    }
    ...
    //
    // CIM_ConcreteJob_GetError_Class.MIReturn
    //
    ...
    //
    // CIM_ConcreteJob_GetError_Class.Error
    //
    
    const Field<CIM_Error_Class>& Error() const
    {
        const size_t n = offsetof(Self, Error);
        return GetField<CIM_Error_Class>(n);
    }
    
    void Error(const Field<CIM_Error_Class>& x)
    {
        const size_t n = offsetof(Self, Error);
        GetField<CIM_Error_Class>(n) = x;
    }
    
    const CIM_Error_Class& Error_value() const
    {
        const size_t n = offsetof(Self, Error);
        return GetField<CIM_Error_Class>(n).value;
    }
    
    void Error_value(const CIM_Error_Class& x)
    {
        const size_t n = offsetof(Self, Error);
        GetField<CIM_Error_Class>(n).Set(x);
    }
    
    bool Error_exists() const
    {
        const size_t n = offsetof(Self, Error);
        return GetField<CIM_Error_Class>(n).exists ? true : false;
    }
    
    void Error_clear()
    {
        const size_t n = offsetof(Self, Error);
        GetField<CIM_Error_Class>(n).Clear();
    }
};

typedef Array<CIM_ConcreteJob_GetError_Class> CIM_ConcreteJob_GetError_ClassA;

class CIM_ConcreteJob_GetErrors_Class : public Instance
{
public:
    
    typedef CIM_ConcreteJob_GetErrors Self;
    
    CIM_ConcreteJob_GetErrors_Class() :
        Instance(&CIM_ConcreteJob_GetErrors_rtti)
    {
    }
    
    CIM_ConcreteJob_GetErrors_Class(
        const CIM_ConcreteJob_GetErrors* instanceName,
        bool keysOnly) :
        Instance(
    ...
    CIM_ConcreteJob_GetErrors_Class& operator=(
        const CIM_ConcreteJob_GetErrors_Class& x)
    {
        CopyRef(x);
        return *this;
    }
    ...
    //
    // CIM_ConcreteJob_GetErrors_Class.MIReturn
    //
    ...
    //
    // CIM_ConcreteJob_GetErrors_Class.Errors
    //
    
    const Field<CIM_Error_ClassA>& Errors() const
    {
        const size_t n = offsetof(Self, Errors);
        return GetField<CIM_Error_ClassA>(n);
    }
    
    void Errors(const Field<CIM_Error_ClassA>& x)
    {
        const size_t n = offsetof(Self, Errors);
        GetField<CIM_Error_ClassA>(n) = x;
    }
    
    const CIM_Error_ClassA& Errors_value() const
    {
        const size_t n = offsetof(Self, Errors);
        return GetField<CIM_Error_ClassA>(n).value;
    }
    
    void Errors_value(const CIM_Error_ClassA& x)
    {
        const size_t n = offsetof(Self, Errors);
        GetField<CIM_Error_ClassA>(n).Set(x);
    }
    
    bool Errors_exists() const
    {
        const size_t n = offsetof(Self, Errors);
        return GetField<CIM_Error_ClassA>(n).exists ? true : false;
    }
    
    void Errors_clear()
    {
        const size_t n = offsetof(Self, Errors);
        GetField<CIM_Error_ClassA>(n).Clear();
    }
};

typedef Array<CIM_ConcreteJob_GetErrors_Class> CIM_ConcreteJob_GetErrors_ClassA;
