require "json"
require_relative "../rest-client-2.1.0/rest-client"
  ...
  module ClientMixin
    ...
    def define_entity_methods
      @entities.values.each do |entity|
        ...
        define_singleton_method("get_#{entity.method_names[0]}") do |name, namespace = nil, opts = {}|
          get_entity(entity.resource_name, name, namespace, opts)
        end

        define_singleton_method("delete_#{entity.method_names[0]}") do |name, namespace = nil, opts = {}|
        ...
        define_singleton_method("json_patch_#{entity.method_names[0]}") do |name, patch, namespace = nil|
          patch_entity(entity.resource_name, name, patch, "json-patch", namespace)
        end

        define_singleton_method("merge_patch_#{entity.method_names[0]}") do |name, patch, namespace = nil|
