...
- [Go lang](https://golang.org/) for building go code. Go lang version 1.18.14 (both Linux & Windows)
...
1. Install go1.18.14, dotnet, powershell, docker and build dependencies to build go code for both Linux and Windows platforms
```
